...
# DEC_events <- TRUE 
```
There are cases where the user wishes to define his/her own matrix of dispersal and extirpation events. Let us first see what the default matrix is like, we do that with the following lines:
