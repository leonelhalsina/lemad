...
```
Those are the probabilities for the internal nodes 67, 68 up to 72. Now, one can use a function to plot those values into our phylogenetic tree (function not provided in LEMAD yet).
