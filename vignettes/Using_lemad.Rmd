...
```
This vignette does run the analysis itself. You will see all the loglik values that are tried out during the optimization. That is what you normally see in your console when running an analysis. I will now show what the output is like.
```{r}
output_vig$model_ml
